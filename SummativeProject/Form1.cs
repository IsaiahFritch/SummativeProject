...
namespace SummativeProject
{
    public partial class Form1 : Form
    {
        ...
        //background
        Rectangle backgroundWallsOne = new Rectangle(0, 0, 424, 900);
        Rectangle backgroundWallsTwo = new Rectangle(975, 0, 425, 900);
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //e.Graphics.FillRectangle(orangeBrush, backgroundWallsOne);
            //e.Graphics.FillRectangle(orangeBrush, backgroundWallsTwo);


            //player projectiles -- flamethrower: burn extra calories!
            for (int i = 0; i < playerProjectiles.Count(); i++)
            {
                if (playerProjectilesLifespan[i] < 30)
                {
            ...
            //hearts
            e.Graphics.FillRectangle(darkredBrush, topHeart);
            e.Graphics.FillRectangle(darkredBrush, middleHeart);
            e.Graphics.FillRectangle(darkredBrush, bottomHeart);
